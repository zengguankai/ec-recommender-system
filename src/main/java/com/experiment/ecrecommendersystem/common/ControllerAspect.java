...
import com.experiment.ecrecommendersystem.controller.admin.AdminController;
...
public class ControllerAspect {
    ...
    @Around("execution(* com.experiment.ecrecommendersystem.controller.admin.*.*(..)) && @annotation(org.springframework.web.bind.annotation.RequestMapping)")
